...
| --- | --- | --- | --- |
| heron_world.launch | Selects the Gazebo world, display mode, ROS graph, plant profile, canonical sensor-frame file, vehicle spawn, optional marker, and separate provisional DT100/Ping360 extrinsic revisions. | gazebo_ros, heron_simulator configuration and worlds | grande/launch/bringup.launch |
