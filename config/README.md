...
| --- | --- | --- | --- |
| scenarios.yaml | Registers named scenarios, including the isolated range-marker pool, and selects the default scenario. | config/scenarios/*.yaml | scripts/scenarios.py, GRANDE scenario selection |
