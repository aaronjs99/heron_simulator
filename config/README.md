...
| --- | --- | --- | --- |
| empirical_actuator_proxy.json | Provides the installed, explicitly simulation-only electrical current-shape proxy selected by empirical propulsion campaigns; it is not a physical thrust calibration. | Provenance-bound actuator candidate | grande/launch/bringup.launch, drive_to_thrusters.py |
