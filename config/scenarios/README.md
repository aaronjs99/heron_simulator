...
| --- | --- | --- | --- |
| collision_avoidance_arena.yaml | Binds the static-post collision world and its immutable evaluation geometry to a coincident map frame and start pose. | heron_simulator/worlds/collision_avoidance_arena.world, heron_simulator/config/entities/collision_avoidance_arena.yaml | heron_simulator/config/scenarios.yaml, GRANDE S5.0 campaign 0.10 |
