...
| --- | --- | --- | --- |
| collision_avoidance_arena.yaml | Freezes the exact center-post cylinder used by independent padded-hull clearance evaluation, plus nonblocking lidar registration structures. | None | heron_simulator/config/scenarios/collision_avoidance_arena.yaml, GRANDE S5.0 campaign 0.10 |
