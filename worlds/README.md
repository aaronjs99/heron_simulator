...
| --- | --- | --- | --- |
| collision_avoidance_arena.world | Defines one direct-chord cylindrical obstacle and three nonblocking registration structures for bounded deployment-path collision evidence. | water_surface model | heron_simulator/config/scenarios/collision_avoidance_arena.yaml, archived GRANDE S5.0 campaign 0.10 |
